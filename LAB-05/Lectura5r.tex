...
\begin{titlepage}
    ...
    \vspace*{\fill}
    {\Huge Autovalores y Autovectores \par} % Título sin negritas ni cursivas
...
% Aquí empieza el informe
\section*{\textnormal{Resumen}} % Título al inicio de la página, centrado y sin numeración
...
\section{\textnormal{Autovalores y Autovectores}} % Título alineado a la izquierda y enumerado.
